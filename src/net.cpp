...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TUcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tucointools.com", "159.203.117.240"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tucointools.com", "testnet-seed.tucointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TUcoin is probably already running."), addrBind.ToString().c_str());
        else
